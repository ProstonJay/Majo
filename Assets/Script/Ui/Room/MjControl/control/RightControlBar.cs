...
public class RightControlBar : MonoBehaviour {
    ...
    private IEnumerator ShowA()
    {
        ...
        for (int i = 0; i < handList.Count; i++)
        {
            ...
            mjCard.transform.localPosition = new Vector3(i * 8, i * -36 + 10, 0);
            mjCard.transform.SetParent(this.transform, false);
            mjCard.GetComponent<Mj_right_out>().setPic(handList[i].ToString());
    ...
    void Start () {
        ...
        //    mjCard.transform.localPosition = new Vector3(i * 8, i * -36+10, 0);
        //    mjCard.transform.SetParent(this.transform, false);
        //    mjCard.GetComponent<Mj_right_out>().setPic("23");
        //    mjCard.name = i.ToString();
        //    mjList.Add(mjCard);
        //}
    }
